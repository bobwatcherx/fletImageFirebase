...
# ADD URL STORAGE FROM FIREBASE ADMIN DASHOBARD

# YOU MUST REMOVE gs:// FROM URL gs://testdoang-e8396.appspot.com

initialize_app(mycred,{'storageBucket':'testdoang-e8396.appspot.com'})
...
def main(page:Page):
	...
	def uploadnow(e:FilePickerResultEvent):
		for x in e.files:
			try:
				...
				# AND THIS OPTIONALE IF YOU WANT CREATE IMAGE URL
				# IS PUBLIC OR NOT
				blob.make_public()
	...
	ElevatedButton("upload file now",
	bgcolor="blue",
	color="white",
